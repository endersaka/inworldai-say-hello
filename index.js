...
var nodejs_sdk_1 = require("@inworld/nodejs-sdk");
function sayHello() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    client = new nodejs_sdk_1.InworldClient()
                        ...
                        // Attach handlers
                        .setOnError(function (err) { return console.error(err); })
                        .setOnMessage(function (packet) {
                        //console.log(packet);
                        var _a;
                        if (packet.isAudio()) {
                            (_a = packet.audio.additionalPhonemeInfo) === null || _a === void 0 ? void 0 : _a.forEach(function (phoneme) { return console.log(phoneme); });
                        }
                    ...
                    return [4 /*yield*/, connection.sendText('Hello')];
                case 1:
                    // Send your message to a character.
                    _a.sent();
                    return [2 /*return*/];
